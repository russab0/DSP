...
clear()
clf()
BASE = "\Users\Руслан\Desktop\DSP\assignment4\2. Echo\"
...
figure(8)
plot2d("nl", 1:length(signal), signal, color("blue"))
plot2d("nl", 1:length(signal), signal_removed_echo(1:length(signal)), color("red"))
